...
import '../bin/wrangler.dart' as wrangler_main;
...
''');
    ...
    setUp(() {
      ...
      tmpDir = memoryFileSystem.systemTempDirectory
          .createTempSync('flutter_wrangler_test.');
...
''');
  ...
  group('wrangler command line argument test', () {
    late MemoryFileSystem memoryFileSystem = MemoryFileSystem();
    late Directory tmpDir;
    ...
    test('command line arguments are parsed and passed to generator', () {
      ...
      wrangler_main.wranglerGenerator = mockWranglerGenerator;
      String errorMessage = '';
      errorExit = (String message) {
        errorMessage = message;
      };

      wrangler_main.platform = platform;
      wrangler_main.filesystem = memoryFileSystem;
