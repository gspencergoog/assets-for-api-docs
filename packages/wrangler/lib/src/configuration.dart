...
// Represents the locations of all of the data for wrangler.
class SnippetConfiguration {
  ...
  /// This is the configuration directory for the wrangler system, containing
  /// the skeletons and templates.
  final Directory configDirectory;

  /// This is where the wrangler themselves will be written, in order to be
...
/// A class to compute the configuration of the wrangler input and output
/// locations based in the current location of the wrangler main.dart.
  ...
  FlutterRepoSnippetConfiguration({required this.flutterRoot, super.filesystem})
      : super(
          configDirectory: _underRoot(filesystem, flutterRoot,
              const <String>['dev', 'wrangler', 'config']),
          outputDirectory: _underRoot(filesystem, flutterRoot,
              const <String>['dev', 'docs', 'doc', 'wrangler']),
          skeletonsDirectory: _underRoot(filesystem, flutterRoot,
              const <String>['dev', 'wrangler', 'config', 'skeletons']),
          templatesDirectory: _underRoot(
            filesystem,
            flutterRoot,
            const <String>['dev', 'wrangler', 'config', 'templates'],
          ),
        );
